...
// Frames are paced by a millisecond timer, so the reachable rates are quantised:
// 8ms is 125, 7ms is 143, 6ms is 167. 250 is the ceiling because the setting is
// stored in a byte.
const int MAX_FPS_LIMIT = 250;
